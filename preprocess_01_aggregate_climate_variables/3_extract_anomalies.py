...
### This code is for processing the climate data (ERA5 / GLEAM) (0.25deg), and calculating the anomalies in the origianl units by removing the mean seasonal cycle of the whole climatology (1985 - 2023), and then calculating the normalized anomalies per pixel by dividing the anomnalies by the standard deviation of the whole climatology.
