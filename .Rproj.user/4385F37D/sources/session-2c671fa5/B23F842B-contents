...
#### 0_create_dataframe.R
This R script combines raw EM-DAT data (that the user should download and provide individually), with the ancillary data we provide, in order to create the dataframe that will be used for the analysis.
