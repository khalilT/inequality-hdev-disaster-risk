...
### Calculate OR likelihood of economic damages per sHDI group & disaster type
boot_odds_damages <- function(distype){
  print(paste("calculate ORs risk econ. damages, per sHDI group for ", distype, " disaster type"))
  #sample data 
  sample_disaster_hdi <- disasters_df %>% 
...
### calculate OR likelihood of economci damages, sHDI groups and deviation levels
boot_odds_inequality_damages_all <- function(distype){
  print(paste("calculate ORs risk econ. damages, per sHDI group and HDI deviation subgroups for ", distype, " disaster type"))
  #sample data
  sample_vhigh_hdi <- disasters_df %>% 
